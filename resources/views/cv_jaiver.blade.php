                    ...
                    <div class="section-heading">
                        ...
                        <p>
                            @foreach ($technologies as $technology)
                                <br>
                                <b><u>{{ $technology['technology'] }}</u></b> <span
                                    class="experience">{{ $technology['experience'] }}</span>
                                </br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
                    <form id="contact" action={{route("contact_cv" )}} method="post" onsubmit="return miFuncion()">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <fieldset>
                                    ...
                                    @endif
                                    <input type="name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" placeholder="Nombre" autocomplete="on" value="{{ old('name') }}" maxlength="50" autofocus required >
                                </fieldset>
                            </div>
                            <div class="col-lg-6">
                                <fieldset>
                                    ...
                                    @endif
                                    <input type="text" class="form-control{{ $errors->has('company') ? ' is-invalid' : '' }}" name="company" id="company" placeholder="Compañia" value="{{ old('company') }}" maxlength="50" autocomplete="on"  required>
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <fieldset>
                                    ...
                                    <p class="error-form">{{ $errors->first('company') }}</p>   
                                    @endif
                                    <input type="text" name="email" id="email" pattern="[^ @]*@[^ @]*" placeholder="Email" maxlength="50" required="" value="{{ old('email') }}" autocomplete="on"  required>
                                </fieldset>
                            </div>
                            <div class="col-lg-12">
                                <p class="error-form">{{ $errors->first('mensaje') }}</p>   
                                  <textarea class="form-control" id="write_suggestions" onKeyDown="kotoba_suggestions()" onKeyUp="kotoba_suggestions()"  name="mensaje" rows="3" required="true" maxlength="200" >{{  (old('mensaje'))? old('mensaje'):''}} </textarea>
                                    <small id="emailHelp" class="form-text text-muted"><div id="mensaje" readonly></div></small>
